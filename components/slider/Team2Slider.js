                ...
                <Swiper {...swiperOptions}>
                    <SwiperSlide>
                        <div className="card-team-2">
                            <div className="card-image"><img src="/assets/imgs/page/homepage2/team1.png" alt="Retvens" /></div>
                    ...
                    <SwiperSlide>
                        <div className="card-team-2">
                            <div className="card-image"><img src="/assets/imgs/page/homepage2/team2.png" alt="Retvens" /></div>
                            <div className="card-info"><Link href="#">
                                <h6>Foysal Khan</h6>
                            </Link>
                                <p className="text-lg neutral-600">Master Trainer</p>
                    ...
                    <SwiperSlide>
                        <div className="card-team-2">
                            <div className="card-image"><img src="/assets/imgs/page/homepage2/team3.png" alt="Retvens" /></div>
                            <div className="card-info"><Link href="#">
                                <h6>Ava Smith</h6>
                            </Link>
                                <p className="text-lg neutral-600">Master Trainer</p>
                    ...
                    <SwiperSlide>
                        <div className="card-team-2">
                            <div className="card-image"><img src="/assets/imgs/page/homepage2/team4.png" alt="Retvens" /></div>
                            <div className="card-info"><Link href="#">
