        ...
        <>
            <footer className="footer footer-style-3 footer-style-5">
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 col-sm-12 mb-30"><Link href="/"><img alt="Retvens" src="/assets/imgs/template/logo.svg" /></Link>
                            <div className="mt-20 mb-20">
                                <p className="text-md neutral-600 mb-10">401, Princes, Business Skyline, Vijay Nagar, Indore, Madhya Pradesh 452010</p>
                        ...
                        <div className="col-md-6 col-sm-12">
                            <div className="row">
                                ...
                                <div className="col-lg-3 col-md-6 mb-30">
                                    <h5 className="neutral-0 mb-10 text-18-semibold neutral-0">Products</h5>
                                    <ul className="menu-footer">
                                    ...
                                    <div className="col-md-6 mb-20">
                                        <div className="text-center text-md-start">
                                            <div className="text-start d-inline-block">
                                                ...
                                                </p><div className="box-socials-footer"><Link className="icon-socials icon-facebook" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/fb.svg" /></Link><Link className="icon-socials icon-instagram" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/in.svg" /></Link><Link className="icon-socials icon-twitter" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/tw.svg" /></Link><Link className="icon-socials icon-be" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/be.svg" /></Link></div>
                                                <p />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-6 mb-20">
                                        <p className="text-sm neutral-600">Copyright © 2023 Retvens. All rights reserved.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
