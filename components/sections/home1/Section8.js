                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 mb-30">
                            <div className="box-image-neutral-1000"><img src="/assets/imgs/page/homepage1/img-discover.png" alt="Retvens" /></div>
                        </div>
                        <div className="col-lg-6 mb-30">
                            <h2>Discover insights across all your data with Retvens Platform</h2>
                                            ...
                                            <SwiperSlide>
                                                <div className="item-review-discover">
                                                    ...
                                                    <div className="box-author-review">
                                                        <div className="box-author"><Link href="#"><img src="/assets/imgs/page/homepage1/author.png" alt="Retvens" /></Link>
                                                        ...
                                                        <div className="author-brand"><Link href="#"><img src="/assets/imgs/page/homepage1/mint.png" alt="Retvens" /></Link></div>
                                                    </div>
                                                </div>
                                            </SwiperSlide>
                                            <SwiperSlide>
                                                <div className="item-review-discover">
                                                    ...
                                                    <div className="box-author-review">
                                                        <div className="box-author"><Link href="#"><img src="/assets/imgs/page/homepage1/author2.png" alt="Retvens" /></Link>
                                                        ...
                                                        <div className="author-brand"><Link href="#"><img src="/assets/imgs/page/homepage1/logo6.png" alt="Retvens" /></Link></div>
                                                    </div>
                                                </div>
                                            </SwiperSlide>
                                        </Swiper>
