                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 mb-40">
                            ...
                            <p className="text-lg neutral-700">Retvens is an independent web design studio with a rich history.
                        ...
                        <div className="col-lg-6 text-center mb-40">
                            <div className="box-border-image">
                                <div className="box-image-line-1">
                                    <div className="wow fadeInDown img-1" data-wow-delay={0}><img src="/assets/imgs/page/homepage1/img-track2-1.png" alt="Retvens" /></div>
                                    <div className="wow fadeInDown img-1" data-wow-delay="0.3s"><img src="/assets/imgs/page/homepage1/img-track2-2.png" alt="Retvens" /></div>
                                </div>
                                <div className="box-image-line-2">
                                    <div className="wow fadeInLeft img-1" data-wow-delay={0}><img src="/assets/imgs/page/homepage1/img-track2-3.png" alt="Retvens" /></div>
                                    <div className="wow fadeInRight img-1" data-wow-delay="0.2s"><img src="/assets/imgs/page/homepage1/img-track2-4.png" alt="Retvens" /></div>
                                </div>
                                <div className="box-image-line-3">
                                    <div className="wow fadeInUp img-1" data-wow-delay={0}><img src="/assets/imgs/page/homepage1/img-track2-5.png" alt="Retvens" /></div>
                                    <div className="wow fadeInUp img-2" data-wow-delay="0.2s"><img src="/assets/imgs/page/homepage1/img-track2-6.png" alt="Retvens" /></div>
                                    <div className="wow fadeInUp img-3" data-wow-delay="0.4s"><img src="/assets/imgs/page/homepage1/img-track2-7.png" alt="Retvens" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
