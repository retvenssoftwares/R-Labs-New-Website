            ...
            <section className="section-box box-companion">
                <div className="container">
                    ...
                    <div className="row mt-130">
                        <div className="col-lg-6"><img alt="Retvens" src="/assets/imgs/page/homepage3/img-companion6.png" /></div>
                        <div className="col-lg-6">
                            <h2 className="heading-2 neutral-0 mb-20">Find actionable insights, and generate reports</h2>
                            <p className="text-lg neutral-200">Retvens is an independent web design studio with a rich history.
