                ...
                <div className="banner-hero hero-3">
                    <div className="banner-inner">
                        <div className="container">
                            ...
                            <div className="box-download-app justify-content-center"><Link href="#"><img src="/assets/imgs/page/homepage6/googleplay.png" alt="Retvens" /></Link><Link href="#"><img src="/assets/imgs/page/homepage6/appstore.png" alt="Retvens" /></Link></div>
                        </div>
                    </div>
                </div>
            </section>
