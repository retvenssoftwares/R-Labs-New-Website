                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 mb-40">
                            ...
                            <h2 className="heading-2 mb-20">Retvens Platform - The best way to build your startup.</h2>
                        ...
                        <div className="col-lg-6 mb-40">
                            <div className="image-feature-2"><img src="/assets/imgs/page/homepage3/img-feature.png" alt="Retvens" />
