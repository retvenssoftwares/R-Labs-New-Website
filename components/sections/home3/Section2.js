                        ...
                        <div className="lists-our-features mt-35">
                            <div className="item-our-feature feature-big">
                                <div className="card-enjoy-style-2">
                                    <div className="card-image"><Link href="#"><img src="/assets/imgs/page/homepage3/global.png" alt="Retvens" /></Link></div>
                            ...
                            <div className="item-our-feature feature-mid">
                                <div className="card-enjoy-style-2">
                                    <div className="card-image"><Link href="#"><img src="/assets/imgs/page/homepage3/planner.png" alt="Retvens" /></Link></div>
                                    <div className="card-info"><Link href="#">
                            ...
                            <div className="item-our-feature feature-sm">
                                <div className="card-enjoy-style-2">
                                    <div className="card-image"><Link href="#"><img src="/assets/imgs/page/homepage3/report.png" alt="Retvens" /></Link></div>
                                    <div className="card-info"><Link href="#">
                            ...
                            <div className="item-our-feature feature-sm">
                                <div className="card-enjoy-style-2">
                                    <div className="card-image"><Link href="#"><img src="/assets/imgs/page/homepage3/trusted.png" alt="Retvens" /></Link></div>
                                    <div className="card-info"><Link href="#">
                            ...
                            <div className="item-our-feature feature-mid">
                                <div className="card-enjoy-style-2">
                                    <div className="card-image"><Link href="#"><img src="/assets/imgs/page/homepage3/payment.png" alt="Retvens" /></Link></div>
                                    <div className="card-info"><Link href="#">
                            ...
                            <div className="item-our-feature feature-big">
                                <div className="card-enjoy-style-2">
                                    <div className="card-image"><Link href="#"><img src="/assets/imgs/page/homepage3/support.png" alt="Retvens" /></Link></div>
                                    <div className="card-info"><Link href="#">
