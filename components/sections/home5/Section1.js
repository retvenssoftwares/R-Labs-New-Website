                            ...
                            <div className="row">
                                <div className="col-lg-8">
                                    <div className="block-banner">
                                        ...
                                        Empowering Hospitality<br className="d-none d-lg-block" /> Through Innovation</h1>
                                        <div className="banner-description text-xl mb-60 mt-30 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">We transform the hospitality industry with cutting-edge technology. 
                                            Discover how we enhance efficiency and elevate guest experiences..</div>
