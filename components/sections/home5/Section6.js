        ...
        <>
            ...
            <section className="section-box box-our-features">
                <div className="container">
                    <div className="text-center"><span className="btn btn-bg-linear-2 "><span>
                        ...
                        </span> RateX Features</span>
                        <h2 className="display-2 neutral-1000 mb-75">Powerful analytics to help you<br className="d-none d-lg-block" /> scale your hotel</h2>
                    </div>
                    <div className="row align-items-center">
                        <div className="col-lg-3 text-end">
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/safe.png" alt="Retvens" /></div>
                                <div className="card-info">
                                    <h3>Sell better inventory </h3>
                                    <p className="text-md">Sell beyond your inventory with a powerful softwares that allows hotel owners to sell automatically, even if they're busy with another stuffs.</p>
                                </div>
                            </div>
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/transaction.png" alt="Retvens" />
                                </div>
                                <div className="card-info">
                                    <h3>Manage your entire hotel</h3>
                                    <p className="text-md">Inventory, Adr and Revenue, Compset, Market Demand, Dynamic Pricing, and more, all on one platform.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 text-center">
                            <div className="box-main-img-feature"><img src="/assets/imgs/page/v1/products/ratex/landing.png" alt="Retvens" />
                                <div className="img-sub-1 shape-1"><img src="/assets/imgs/page/homepage6/qrcode.png" alt="Retvens" />
                                </div>
                                <div className="img-sub-2 shape-3"><img src="/assets/imgs/page/homepage6/storage.png" alt="Retvens" /></div>
                            </div>
                        </div>
                        <div className="col-lg-3">
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/great.png" alt="Retvens" /></div>
                                <div className="card-info">
                                    <h3>Never run out of information</h3>
                                    <p className="text-md">Have the right information at the right time with Hotel Intelligence</p>
                                </div>
                            </div>
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/rapid.png" alt="Retvens" /></div>
                                <div className="card-info">
                                    <h3>Tacking Compset in the easiest way</h3>
                                    <p className="text-md">Maintain a complete record of your Compset, track them directly, get your all updates, check prices and availability, and track every single details from one screen.</p>
                                </div>
                            </div>
                        </div>
                    </div>
