                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-5">
                                <div className="card-features-6 hover-up">
                                    <div className="card-image"><img src="/assets/imgs/page/homepage4/web.png" alt="Retvens" /></div>
                                    <div className="card-info">
                                        ...
                                        <p className="text-sm neutral-400">A startup is started by individual founders or
                                            entrepreneurs to search for a repeatable</p><img className="mt-25" src="/assets/imgs/page/homepage4/img-web.png" alt="Retvens" />
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-7">
                                <div className="card-features-6 hover-up">
                                    <div className="card-image"><img src="/assets/imgs/page/homepage4/global.png" alt="Retvens" />
                                    </div>
                                    <div className="card-info">
                                ...
                                <div className="card-features-6 card-arrow-2 hover-up">
                                    <div className="card-image"><img src="/assets/imgs/page/homepage4/laptop.png" alt="Retvens" />
                                    </div>
                                    <div className="card-info">
                                ...
                                <div className="row">
                                    <div className="col-lg-12">
                                        <div className="card-features-6 card-arrow-3 hover-up">
                                            <div className="card-image"><img src="/assets/imgs/page/homepage4/brain.png" alt="Retvens" /></div>
                                            <div className="card-info">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="card-features-6 card-features-300 hover-up">
                                            <div className="card-image"><img src="/assets/imgs/page/homepage4/search.png" alt="Retvens" /></div>
                                            <div className="card-info">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="card-features-6 card-features-300 hover-up">
                                            <div className="card-image"><img src="/assets/imgs/page/homepage4/cloud.png" alt="Retvens" /></div>
                                            <div className="card-info">
