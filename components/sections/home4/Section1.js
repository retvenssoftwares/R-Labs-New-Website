                    ...
                    <div className="container">
                        <div className="banner-inner">
                            ...
                            <div className="box-banner-right">
                                <div className="box-images-banner-6"><span className="animate-1"><img src="/assets/imgs/page/homepage4/banner-arrow.png" alt="Retvens" /></span><span className="animate-2"><img src="/assets/imgs/page/homepage4/banner-icon.png" alt="Retvens" /></span><img src="/assets/imgs/page/homepage4/banner.png" alt="Retvens" />
                                </div>
                            </div>
                        </div>
                    </div>
