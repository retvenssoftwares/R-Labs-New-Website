                                        ...
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                ...
                                                <div className="card-author">
                                                    ...
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author.png" alt="Retvens" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                ...
                                                <div className="card-author">
                                                    <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author2.png" alt="Retvens" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                ...
                                                <div className="card-author">
                                                    <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author3.png" alt="Retvens" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                ...
                                                <div className="card-author">
                                                    <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author4.png" alt="Retvens" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
