                            ...
                            <div className="col-lg-3">
                                <div className="sidebar">
                                    ...
                                    <div className="sidebar-right sidebar-text">
                                        ...
                                        <div className="box-socials-commingsoon mt-15"> <Link className="icon-socials icon-facebook" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/fb.svg" /></Link><Link className="icon-socials icon-instagram" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/in.svg" /></Link><Link className="icon-socials icon-twitter" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/tw.svg" /></Link><Link className="icon-socials icon-be" href="#"><img alt="Retvens" src="/assets/imgs/template/icons/be.svg" /></Link></div>
                                    </div>
                                        ...
                                        <ul className="list-popular-posts">
                                            <li>
                                                <div className="card-post">
                                                    <div className="card-image"> <img alt="Retvens" src="/assets/imgs/page/blog/post.png" /></div>
                                            ...
                                            <li>
                                                <div className="card-post">
                                                    <div className="card-image"> <img alt="Retvens" src="/assets/imgs/page/blog/post2.png" /></div>
                                                    <div className="card-info"> <Link href="#">
                                                        <h6 className="text-18-semibold">25 easy step-by-step tutorials to make
                                                            cool drawings</h6>
                                                    </Link><span className="date-post">16 October 2023</span></div>
                                            ...
                                            <li>
                                                <div className="card-post">
                                                    <div className="card-image"> <img alt="Retvens" src="/assets/imgs/page/blog/post3.png" /></div>
                                                    <div className="card-info"> <Link href="#">
                                                        <h6 className="text-18-semibold">25 easy step-by-step tutorials to make
                                                            cool drawings</h6>
                                                    </Link><span className="date-post">16 October 2023</span></div>
                                            ...
                                            <li>
                                                <div className="card-post">
                                                    <div className="card-image"> <img alt="Retvens" src="/assets/imgs/page/blog/post4.png" /></div>
                                                    <div className="card-info"> <Link href="#">
                                                        <h6 className="text-18-semibold">25 easy step-by-step tutorials to make
                                                            cool drawings</h6>
                                                    </Link><span className="date-post">16 October 2023</span></div>
                                    ...
                                    <div className="box-sidebar-normal"><Link href="#"><img src="/assets/imgs/page/job/ads.png" alt="Retvens" /></Link></div>
                                </div>
                            </div>
                        </div>
                    </div>
