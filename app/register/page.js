                                            ...
                                            <div className="box-form-register">
                                                ...
                                                <form className="form-register" action="#">
                                                    ...
                                                    <div className="other-login">
                                                        ...
                                                        <div className="box-button-register"><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/google.svg" alt="Retvens" /><span>Register with Google</span></Link><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/twitter.svg" alt="Retvens" /></Link><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/linkedin.svg" alt="Retvens" /></Link><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/github.svg" alt="Retvens" /></Link></div>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
