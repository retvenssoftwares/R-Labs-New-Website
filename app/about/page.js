                ...
                <div>
                    <section className="section-box box-about-section-1">
                        <div className="container-fluid">
                                    ...
                                    <div className="padding-left-auto"><Link className="btn btn-tag-black" href="#">About Us</Link>
                                        ...
                                        <div className="box-border-left-author">
                                            ...
                                            <div className="box-joined">
                                                <div className="box-authors"><span className="item-author"><img src="/assets/imgs/page/homepage1/author.png" alt="Retvens" /></span><span className="item-author"><img src="/assets/imgs/page/homepage1/author2.png" alt="Retvens" /></span><span className="item-author"><img src="/assets/imgs/page/homepage1/author3.png" alt="Retvens" /></span><span className="item-author"><span className="text-num-author text-md-bold color-brand-2">+2k</span></span>
                                                </div><span className="text-lg d-inline-block">Join thousands of users in using<br className="d-none d-md-block" />the Retvens platform!</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="box-image-rect"><img src="/assets/imgs/page/about/img-about.png" alt="Retvens" />
                                        <VideoPopup />
                                    </div>
                                </div>
                            </div>
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="box-image-rect box-image-rect-both"><img src="/assets/imgs/page/about/img-about2.png" alt="Retvens" /></div>
                                </div>
                                <div className="col-lg-6">
                                    <div className="padding-right-auto">
                                        <div className="box-padding-left-50 box-padding-right-50">
                                            ...
                                            <p className="text-lg neutral-700">Retvens is an independent web design studio with a rich
                        ...
                        <div className="container">
                            <div className="row align-items-end">
                                ...
                                <div className="col-lg-8 mb-30">
                                    <div className="row align-items-end">
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award.png" alt="Retvens" />
                                        </div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award2.png" alt="Retvens" />
                                        </div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award3.png" alt="Retvens" />
                                        </div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award4.png" alt="Retvens" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="section-box box-get-touch-section">
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="box-image-get-touch"> <span className="setup"><img src="/assets/imgs/page/about/setup.png" alt="Retvens" /></span><span className="icon-1"><img src="/assets/imgs/page/about/icon.png" alt="Retvens" /></span><img src="/assets/imgs/page/about/img-touch.png" alt="Retvens" /></div>
                                </div>
