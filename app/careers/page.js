                            ...
                            <div className="container">
                                <div className="banner-inner">
                                    ...
                                    <div className="box-banner-right">
                                        <div className="box-images-banner-6"><img src="/assets/imgs/page/careers/banner.png" alt="Retvens" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6 mb-40">
                                    <div className="image-feature-2"><img src="/assets/imgs/page/homepage3/img-feature.png" alt="Retvens" /></div>
                                </div>
                                <div className="col-lg-6 mb-40">
                    ...
                    <section className="section-box box-open-job">
                        <div className="container">
                            <div className="text-center"><span className="btn btn-brand-4-sm">Job openings</span>
                                ...
                                <p className="text-lg">Retvens is an independent web design studio with a rich history. Founded in 1999, it gathered the best web designers  developers.</p>
                    ...
                    <section className="section-box wow animate__animated animate__fadeIn box-how-it-work">
                        <div className="container">
                            <div className="text-center"><Link className="btn btn-brand-4-sm" href="#">How It Works</Link>
                                <h2 className="mt-15 mb-20">How to apply to the Retvens platform<br className="d-none d-lg-block" />and growing your career</h2>
