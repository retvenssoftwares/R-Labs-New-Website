                ...
                <section className="section-box box-content-login">
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6">
                                <div className="box-image-banner-login"><img src="/assets/imgs/page/login/banner.png" alt="Retvens" />
                                    <ul className="list-logos-login">
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo2.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo3.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo4.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo5.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo6.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo7.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo8.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo9.png" alt="Retvens" /></div>
                                        </li>
                                        <li>
                                            <div className="item-logo"><img src="/assets/imgs/page/homepage3/logo1.png" alt="Retvens" /></div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
