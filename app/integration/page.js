                        ...
                        <div className="box-connecting-inner"><span className="planet shape-1" /><span className="arrow-left shape-2" />
                            <div className="container">
                                ...
                                <div className="mt-55 text-center">
                                    <div className="box-logo-integration"><img src="/assets/imgs/page/integration/logo.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo2.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo3.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo4.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo5.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo6.png" alt="Retvens" /><br className="d-none d-lg-block" /><img src="/assets/imgs/page/integration/logo7.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo8.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo9.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo10.png" alt="Retvens" /><img src="/assets/imgs/page/integration/logo11.png" alt="Retvens" /></div>
                                </div>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="container">
                            ...
                            <div className="row mt-60">
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo.png" alt="Retvens" /></div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo4.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Hublot</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo11.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Dumani</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo10.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Webflow</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo2.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Shopify</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo3.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Kickstar</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo5.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Pinterest</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo7.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Zappier</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo12.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Slack</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo13.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Salesforce</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo14.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Dmark</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-4">
                                    <div className="card-integration">
                                        <div className="card-image">
                                            <div className="card-image-left"><img src="/assets/imgs/page/integration/logo15.png" alt="Retvens" /></div>
                                            <div className="card-image-info">
                                                <h5>Mail Chip</h5>
                                                <p className="text-md neutral-500">Company</p>
                                            </div>
