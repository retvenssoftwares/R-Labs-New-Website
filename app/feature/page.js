                    ...
                    <section className="section-box box-content-feature">
                        <div className="container">
                            <div className="text-center"> <span className="btn btn-bg-brand-4 mb-25"><span>
                                ...
                                <h2 className="mt-15 mb-15">What You Get From Retvens Platform</h2>
                                <p className="text-lg neutral-500 mb-25">Let's browse through all the great features you'll get when<br className="d-none d-lg-block" />you're in the Retvens ecosystem</p>
                            </div>
                            <div className="row">
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature.png" alt="Retvens" /></div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature2.png" alt="Retvens" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature3.png" alt="Retvens" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature4.png" alt="Retvens" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature5.png" alt="Retvens" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature6.png" alt="Retvens" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature7.png" alt="Retvens" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature8.png" alt="Retvens" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature9.png" alt="Retvens" /></div>
                                        <div className="card-info">
                        ...
                        <div className="container">
                            <div className="row align-items-end">
                                ...
                                <div className="col-lg-8 mb-30">
                                    <div className="row align-items-end">
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award.png" alt="Retvens" /></div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award2.png" alt="Retvens" /></div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award3.png" alt="Retvens" /></div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award4.png" alt="Retvens" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
